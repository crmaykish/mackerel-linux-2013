...
static const struct usb_device_id products[] = {
	...
	//{QMI_FIXED_INTF(0x1e2d, 0x0054, 1)},	/* Cinterion PX8 */
#if 0
	{	/* Cinterion PX8 */
		USB_VENDOR_AND_INTERFACE_INFO(0x1e2d, USB_CLASS_CDC_DATA, 0x00, 0x00),
		.driver_info        = (unsigned long)&qmi_wwan_info,
	},
	{ USB_DEVICE_AND_INTERFACE_INFO(0x1e2d, 0x0054, USB_CLASS_CDC_DATA, 0x00, 0x00),
		.driver_info        = (unsigned long)&qmi_wwan_info,
	},
#endif
