...
#define MX25_PAD_A17__FEC_TX_ERR	IOMUX_PAD(0x238, 0x01c, 0x17, 0, 0, NO_PAD_CTRL)
...
#define MX25_PAD_A22__FEC_TDATA2	IOMUX_PAD(0x000, 0x030, 0x17, 0, 0, NO_PAD_CTRL)
...
#define MX25_PAD_A23__FEC_TDATA3	IOMUX_PAD(0x24c, 0x034, 0x17, 0, 0, NO_PAD_CTRL)
...
#define MX25_PAD_CS4__CSPI_MOSI		IOMUX_PAD(0x264, 0x054, 0x16, 0, 0, NO_PAD_CTRL)
...
#define MX25_PAD_CS5__CSPI3_MISO	IOMUX_PAD(0x268, 0x058, 0x16, 0, 0, NO_PAD_CTRL)
...
#define MX25_PAD_CONTRAST__WDOG_B	IOMUX_PAD(0x310, 0x118, 0x17, 0, 0, NO_PAD_CTRL)
...
#define MX25_PAD_CSI_D6__CSPI3_SS0	IOMUX_PAD(0x328, 0x130, 0x17, 0, 0, NO_PAD_CTRL)
...
#define MX25_PAD_SD1_CMD__CSPI2_MOSI	IOMUX_PAD(0x388, 0x190, 0x11, 0x4a0, 1, NO_PAD_CTRL)
...
#define MX25_PAD_SD1_CLK__CSPI2_MISO	IOMUX_PAD(0x38c, 0x194, 0x11, 0x49c, 1, NO_PAD_CTRL)
...
#define MX25_PAD_SD1_DATA0__CSPI2_SCLK	IOMUX_PAD(0x390, 0x198, 0x11, 0x494, 1, NO_PAD_CTRL)
...
#define MX25_PAD_SD1_DATA3__CSPI2_SS1	IOMUX_PAD(0x39c, 0x1a4, 0x11, 0x4a8, 1, NO_PAD_CTRL)
...
#define MX25_PAD_KPP_ROW0__UART1_DTR	IOMUX_PAD(0x3a0, 0x1a8, 0x14, 0, 0, NO_PAD_CTRL)
