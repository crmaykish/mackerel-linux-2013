...
# SnapGear Apps/Libs
#
CONFIG_PROP_FLASH_FLASH=y
# CONFIG_PROP_FLASH_BOOT_LOCKED is not set
# CONFIG_PROP_FLASH_TAGS_LOCKED is not set
CONFIG_PROP_FLASH_TAG_BASE=0x0
CONFIG_PROP_FLASH_TAG_OFFSET=0x0
CONFIG_PROP_FLASH_TAG_SIZE=0x0
CONFIG_PROP_FLASH_TAG_ERASED=0xff
# CONFIG_PROP_FLASH_LEGACY is not set
...
CONFIG_USER_BUSYBOX_MKFS_EXT2=y
