...
#
# CONFIG_LIB_LIBNVRAM is not set
...
# CONFIG_LIB_IPTABLES is not set
...
# Accelecon Apps/Libs
#
# CONFIG_PROP_ATHEROS_ART is not set
# CONFIG_PROP_SMX_PBM is not set
# CONFIG_PROP_SMX_SMX is not set
# CONFIG_PROP_SMX_SYSLOG is not set
# CONFIG_PROP_RALINK_COMPAT is not set
# CONFIG_PROP_LCD_LCD is not set
# CONFIG_PROP_KEY_KEY is not set
# CONFIG_PROP_GPIO_DX_GPIO is not set

#
# Accelecon Automake Apps/Libraries
#
# CONFIG_PROP_ACCELECON is not set
# CONFIG_PROP_ACCNS_CERTIFICATES is not set
# CONFIG_PROP_GPIO is not set
# CONFIG_PROP_MODEM_SUPPORT is not set
# CONFIG_PROP_NB_MODEM_MONITOR is not set
# CONFIG_PROP_NB_SCRIPTS is not set
# CONFIG_PROP_NBFX_NOTIFICATIONS is not set
# CONFIG_PROP_QMODEM is not set
# CONFIG_PROP_SCMD is not set
# CONFIG_PROP_WAIT_FOR_FILES is not set
...
# CONFIG_USER_UBOOT_ENVTOOLS is not set
...
# CONFIG_USER_GOAHEAD_GOAHEAD is not set
...
# CONFIG_USER_HOSTAPD_HOSTAPD is not set
...
# CONFIG_USER_BUSYBOX_LONG_OPTS is not set
...
CONFIG_USER_BUSYBOX_SYSROOT=""
CONFIG_USER_BUSYBOX_EXTRA_CFLAGS=""
CONFIG_USER_BUSYBOX_EXTRA_LDFLAGS=""
CONFIG_USER_BUSYBOX_EXTRA_LDLIBS=""
...
#
# CONFIG_USER_BUSYBOX_FEATURE_SYSTEMD is not set
# CONFIG_USER_BUSYBOX_FEATURE_RTMINMAX is not set
CONFIG_USER_BUSYBOX_PASSWORD_MINLEN=6
CONFIG_USER_BUSYBOX_MD5_SMALL=1
CONFIG_USER_BUSYBOX_SHA3_SMALL=1
...
CONFIG_USER_BUSYBOX_FEATURE_SKIP_ROOTFS=y
# CONFIG_USER_BUSYBOX_MONOTONIC_SYSCALL is not set
...
# Archival Utilities
#
# CONFIG_USER_BUSYBOX_FEATURE_SEAMLESS_XZ is not set
...
CONFIG_USER_BUSYBOX_GZIP_FAST=0
...
# CONFIG_USER_BUSYBOX_FEATURE_TAR_NOPRESERVE_TIME is not set
...
# CONFIG_USER_BUSYBOX_FEATURE_DATE_COMPAT is not set
...
# CONFIG_USER_BUSYBOX_FEATURE_TOUCH_SUSV3 is not set
...
# CONFIG_USER_BUSYBOX_FEATURE_DD_THIRD_STATUS_LINE is not set
# CONFIG_USER_BUSYBOX_FEATURE_DD_IBS_OBS is not set
CONFIG_USER_BUSYBOX_DF=y
CONFIG_USER_BUSYBOX_FEATURE_DF_FANCY=y
...
# CONFIG_USER_BUSYBOX_FEATURE_VI_REGEX_SEARCH is not set
...
CONFIG_USER_BUSYBOX_MODPROBE_SMALL=y
CONFIG_USER_BUSYBOX_FEATURE_MODPROBE_SMALL_OPTIONS_ON_CMDLINE=y
...
# CONFIG_USER_BUSYBOX_FLOCK is not set
...
# CONFIG_USER_BUSYBOX_FEATURE_GETOPT_LONG is not set
...
CONFIG_USER_BUSYBOX_LSPCI=y
CONFIG_USER_BUSYBOX_LSUSB=y
...
CONFIG_USER_BUSYBOX_FTPD=y
CONFIG_USER_BUSYBOX_FEATURE_FTP_WRITE=y
CONFIG_USER_BUSYBOX_FEATURE_FTPD_ACCEPT_BROKEN_LIST=y
...
# CONFIG_USER_BUSYBOX_FEATURE_WGET_TIMEOUT is not set
...
# Process Utilities
#
# CONFIG_USER_BUSYBOX_IOSTAT is not set
# CONFIG_USER_BUSYBOX_LSOF is not set
# CONFIG_USER_BUSYBOX_MPSTAT is not set
# CONFIG_USER_BUSYBOX_NMETER is not set
# CONFIG_USER_BUSYBOX_PMAP is not set
# CONFIG_USER_BUSYBOX_POWERTOP is not set
# CONFIG_USER_BUSYBOX_PSTREE is not set
# CONFIG_USER_BUSYBOX_PWDX is not set
# CONFIG_USER_BUSYBOX_SMEMCAP is not set
...
# CONFIG_USER_BUSYBOX_FEATURE_PS_LONG is not set
...
# CONFIG_USER_INOTIFY_TOOLS is not set
# CONFIG_USER_INPUT_EVENT_DAEMON is not set
# CONFIG_USER_IPSEC_TOOLS is not set
# CONFIG_USER_KISMET is not set
# CONFIG_USER_LUA is not set
# CONFIG_USER_LZMA is not set
# CONFIG_USER_MII_DIAG is not set
# CONFIG_USER_NUTTCP is not set
# CONFIG_USER_PYTHON is not set
# CONFIG_USER_READLINE is not set
# CONFIG_USER_SNORT_BARNYARD is not set
# CONFIG_USER_SYSKLOGD is not set
...
# Bootloaders
#
# CONFIG_BOOT_UBOOT is not set
# CONFIG_BOOT_UBOOT_BB is not set
