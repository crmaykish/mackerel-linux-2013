...
CONFIG_USER_BUSYBOX_FEATURE_AR_CREATE=y
...
CONFIG_USER_BUSYBOX_FEATURE_GZIP_LONG_OPTIONS=y
...
CONFIG_USER_BUSYBOX_FEATURE_CHOWN_LONG_OPTIONS=y
...
CONFIG_USER_BUSYBOX_FEATURE_MKDIR_LONG_OPTIONS=y
...
CONFIG_USER_BUSYBOX_SPLIT=y
CONFIG_USER_BUSYBOX_FEATURE_SPLIT_FANCY=y
...
CONFIG_USER_BUSYBOX_FEATURE_FIND_LINKS=y
...
# CONFIG_USER_BUSYBOX_FEATURE_EXTRA_QUIET is not set
# CONFIG_USER_BUSYBOX_FEATURE_INIT_COREDUMPS is not set
CONFIG_USER_BUSYBOX_FEATURE_INITRD=y
CONFIG_USER_BUSYBOX_INIT_TERMINAL_TYPE="linux"
# CONFIG_USER_BUSYBOX_FEATURE_ETC_RC is not set
...
CONFIG_USER_BUSYBOX_USE_BB_CRYPT_SHA=y
...
CONFIG_USER_BUSYBOX_NTPD=y
CONFIG_USER_BUSYBOX_FEATURE_NTPD_SERVER=y
...
CONFIG_USER_BUSYBOX_FEATURE_PS_LONG=y
...
CONFIG_USER_BUSYBOX_FEATURE_SYSLOGD_CFG=y
